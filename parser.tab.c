...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_FUNCTION_HEADER = 3,            /* FUNCTION_HEADER  */
  YYSYMBOL_FUNCTION_SIG = 4,               /* FUNCTION_SIG  */
  YYSYMBOL_LBRACE = 5,                     /* LBRACE  */
  YYSYMBOL_RBRACE = 6,                     /* RBRACE  */
  YYSYMBOL_BLOCK_HEADER = 7,               /* BLOCK_HEADER  */
  YYSYMBOL_GOTO_STMT = 8,                  /* GOTO_STMT  */
  YYSYMBOL_RETURN_STMT = 9,                /* RETURN_STMT  */
  YYSYMBOL_TEXT_LINE = 10,                 /* TEXT_LINE  */
  YYSYMBOL_YYACCEPT = 11,                  /* $accept  */
  YYSYMBOL_program = 12,                   /* program  */
  YYSYMBOL_noise = 13,                     /* noise  */
  YYSYMBOL_functions = 14,                 /* functions  */
  YYSYMBOL_optional_lines = 15,            /* optional_lines  */
  YYSYMBOL_function = 16,                  /* function  */
  YYSYMBOL_17_1 = 17,                      /* $@1  */
  YYSYMBOL_18_2 = 18,                      /* $@2  */
  YYSYMBOL_function_items = 19,            /* function_items  */
  YYSYMBOL_function_item = 20              /* function_item  */
};
...
{
  "\"end of file\"", "error", "\"invalid token\"", "FUNCTION_HEADER",
  "FUNCTION_SIG", "LBRACE", "RBRACE", "BLOCK_HEADER", "GOTO_STMT",
  "RETURN_STMT", "TEXT_LINE", "$accept", "program", "noise", "functions",
  "optional_lines", "function", "$@1", "$@2", "function_items",
  "function_item", YY_NULLPTR
};
